INSERT INTO crop_information (
    latin_name, type, variety, template, seed_spacing_inches, row_spacing_inches, 
...
(
    'Solanum lycopersicum', 'Tomato', 'Beefsteak', True, 18, 24, 12, 36, 70, 
    80, 0, 0, 80, 0, '2024-02-15', '2024-05-01', NULL, '2024-07-15', NULL, 3
),
(
    'Daucus carota', 'Carrot', 'Imperator', True, 2, 12, 2, 12, 70, 
